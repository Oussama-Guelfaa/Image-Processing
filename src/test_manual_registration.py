...
from src.image_processing.manual_point_selection import (
...
def main():
    ...
    plt.tight_layout()
    plt.savefig('manual_original_images.png')
    plt.show()
    ...
    plt.axis('off')
    plt.tight_layout()
    plt.savefig('manual_control_points.png')
    plt.show()
    ...
    superimposed = superimpose(registered_image, target_gray, 'rigid_manual.png', show=True)
